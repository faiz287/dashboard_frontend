...
export default function WebsiteCharts() {
  return (
    <div className="bg-card-bg border border-border-color rounded-2xl p-6 shadow-xs relative overflow-hidden flex flex-col justify-between min-h-[180px]">
      ...
      <div className="space-y-3 relative z-10">
        ...
        <p className="text-xs text-text-secondary leading-relaxed max-w-sm">
          Lead accumulation split across all domains over time
        </p>
      </div>
