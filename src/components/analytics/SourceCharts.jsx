  ...
  const charts = [
    {
      ...
      description: "Top source pages (Contact, Landing, Facebook, etc.) conversion rates",
      icon: Percent
    },
    {
      title: "Website Integration Performance",
      description: "Response times and delivery success rate of form webhook endpoints",
      icon: Activity
    }
  ];
